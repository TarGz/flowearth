...
package fr.digitas.flowearth.media.player.metadata {
	 ...
	 */
	public class SwfMetadata extends Metadata {
		...
		public function fill( li : LoaderInfo ) : Boolean {
			try {
				width 				= li.width;
				height 				= li.height;
				framerate 			= li.frameRate;
				parameters 			= li.parameters;
				swfVersion 			= li.swfVersion;
				actionScriptVersion = li.actionScriptVersion;
				...
				iterable.swfVersion 			= swfVersion;
