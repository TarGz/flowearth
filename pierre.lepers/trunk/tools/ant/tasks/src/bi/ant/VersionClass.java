...
public class VersionClass extends Task {
	...
	private void saveClass(FileOutputStream output) throws IOException{
		...
		writer.println("	 */");
		writer.println("	final public class Version {");
		writer.println("");
		writer.println("		static public const major : uint = "+major+";");
		writer.println("		static public const minor : uint = "+minor+";");
		writer.println("		static public const build : uint = "+buildNumber+";");
		writer.println("");
		writer.println("	}");
		writer.println("}");
