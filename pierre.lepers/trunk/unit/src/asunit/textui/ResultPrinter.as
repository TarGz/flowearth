package asunit.textui 
{
	...
	public class ResultPrinter extends Sprite implements TestListener {
		...
		public function ResultPrinter( version : String = "" , showTrace:Boolean = false) {
		...
		private function configureAssets():void {
			...
			addChild(textArea);
			println("AsUnit " + asunit.runner.Version.id() + " by Luke Bayes and Ali Mills");
			println("Original design by Digitas™ Studio");
			println("_______________________________________________________________________");
			println("UNIT TEST FRAMEWORK VERSION " + version );
			println("");
			println("");
		...
		public override function set height(h:Number):void {
			textArea.height = h - ((gutter*2) + barHeight) - header;
			textArea.y = gutter + header;
