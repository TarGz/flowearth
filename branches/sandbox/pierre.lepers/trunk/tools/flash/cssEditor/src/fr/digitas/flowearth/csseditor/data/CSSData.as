package fr.digitas.flowearth.csseditor.data {
	...
	public class CSSData extends EventDispatcher {
		...
		public function set currentStyle ( sdata : StyleData ) : void {
			if( _currentStyle == sdata) return;
			_currentStyle = sdata;
			dispatchEvent( new CSSEvent( CSSEvent.CURRENT_CHANGE, null ) );
		}
		public function get currentStyle ( ) :  StyleData {
			return _currentStyle;
		}
				
		private var _currentStyle :  StyleData;
